...
export const Home = (): JSX.Element => (
  <div className="container">
    ...
    <main>
      <h1 className="title">entaku</h1>

      <p className="description">Mobile App Developer</p>
      ...
      <a href="https://cb-cloud.com/" target="_blank" rel="noopener noreferrer">
        https://cb-cloud.com/
      </a>
      <p>
      ...
      <ul>
        ...
        <li>Flutterリプレイス 2021/3</li>
      </ul>

      <h3>LifeSports (2018/03〜2019/04)</h3>
      <a href="https://lifesports.jp" target="_blank" rel="noopener noreferrer">
        https://lifesports.jp
      </a>
      <p>
